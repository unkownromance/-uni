<template>
	<uni-popup ref="popview">
		<view @click="prewImg" class="column-start-center border-radius-10 " style="width: 690rpx;">
			<image class="w-100 border-radius-10" mode="widthFix" :src="posterImg.path" />
		</view>
		<!-- <view  class="column-start-center border-radius-10 p_r " style="width: 690rpx;height: 820rpx;">
			<img src="/static/mine/share.png" style="width: 690rpx;height: 820rpx;" class="p_a p_a_all"/>
			<image class="w-80 border-radius-10" style="margin-top: 22%;" mode="widthFix" :src="qrcode.url" />
		</view> -->
...
export default {
	...
	methods: {
		show: function(dic) {
			// this.product = dic;
			this.superData.superRequest('/appBusiness/saleMan/qrCode/get', {},{hubtitle:''}).then(res => {
				...
				views: [
					{
						...
						left: 0,
						// 封面图，测试的时候填上
						url:'/static/mine/share.png'// this.imgArr[this.currIndex]['bgImg']
					},
					{
						type: 'text',
						width: 200,
