<template>
	<div class="mpvue-picker">
		...
		<div class="mpvue-picker-content " :class="{ 'mpvue-picker-view-show': showPicker }">
			...
			<picker-view indicator-style="height: 50px;" class="mpvue-picker-view" :value="pickerValue" @change="pickerChange">
				<picker-view-column>
...
export default {
	...
	methods: {
		...
		pickerChange(e) {
			let changePickerValue = '';
			// #ifdef VUE3
			changePickerValue = e.detail.value;

			// #endif
			// #ifdef VUE2
			changePickerValue = e.mp.detail.value;
		...
		_$emit(emitName) {
			let pickObj = {
				receiveArea: this._getLabel(),
				value: this.pickerValue,
				cityCode: this._getCityCode(),
				provinceCode: this.provinceDataList[this.pickerValue[0]].value,
				districtCode: this.areaDataList[this.pickerValue[2]].value
			};
